            ...
            <div class="col-md-12">
                <div class="card card-default">
                    <div class="card-header" style="background-color: rgb(0,0,0,0.1);">
                        <h3 class="card-title">Quản Lý Khu Vực</h3>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <el-table
                                    ...
                                    <el-table-column prop="maKhuVuc" label="Mã khu vực" sortable></el-table-column>
                                    <el-table-column prop="tenKhuVuc" label="Tên khu vực" ></el-table-column>
