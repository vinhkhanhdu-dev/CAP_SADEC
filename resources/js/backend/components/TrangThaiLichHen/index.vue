            ...
            <div class="col-md-12">
                <div class="card card-default">
                    <div class="card-header" style="background-color: rgb(0,0,0,0.1);">
                        <h3 class="card-title">Quản Lý Danh Sách Trạng Thái Lịch Hẹn</h3>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <el-table
                                    ...
                                    <el-table-column prop="maTrangThai" label="Mã trạng thái" sortable></el-table-column>
                                    <el-table-column prop="tenTrangThai" label="Tên trạng thái" ></el-table-column>
                                    <el-table-column prop="ghiChu" label="Ghi chú" ></el-table-column>
