            ...
            <div class="col-md-12">
                <div class="card card-default">
                    <div class="card-header" style="background-color: rgb(0,0,0,0.1);">
                        <h3 class="card-title">Quản Lý Chi Thu</h3>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <el-table
                                    ...
                                    <el-table-column prop="code" label="Mã" sortable></el-table-column>
                                    <el-table-column prop="tencongviec" label="Tên công việc" ></el-table-column>
                                    <el-table-column prop="sotienchi" label="Số tiền đã chi" ></el-table-column>
                                    <el-table-column prop="sotienthu" label="Số tiền đã thu" ></el-table-column>
                                    <el-table-column prop="chenhlech" label="Tỉ lệ chênh lệch" ></el-table-column>
