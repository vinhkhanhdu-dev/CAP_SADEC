  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <el-menu
      ...
      <template v-for="item in data">
        ...
        v-if="ListModule.includes(item.code) || $store.getters.user.name=='admin1'" :index="item.path" :is="item.children.length > 0? 'el-submenu':'el-menu-item'">
         <i v-if="item.children.length == 0" :class="item.icon?item.icon:'el-icon-setting'"></i>
          <template slot="title">
            ...
            v-if="ListModule.includes(item2.code) || $store.getters.user.name=='admin1'" :key="item2.id" :index="item2.path"  v-for="item2 in item.children"
            ...
            <template slot="title">
                ...
                v-if="ListModule.includes(item3.code) || $store.getters.user.name=='admin1'" :key="item3.id" :index="item3.path" v-for="item3 in item2.children"
